...
+
https://imt.netapp.com/matrix/imt.jsp?components=99343;&solution=1777&isHWU&src=IMT["상호 운용성 매트릭스 툴"]
...
+
을 참조하십시오 link:../deploy/reference_considerations_for_deploying_ontap_tools_for_vmware_vsphere.html["배포 사용자 지정 고려 사항"] 을 참조하십시오.
...
. vCenter Server에 ONTAP 툴이 등록되지 않은 경우 를 사용합니다 ``\https://appliance_ip:8143/Register.html` VSC 인스턴스를 등록합니다.
