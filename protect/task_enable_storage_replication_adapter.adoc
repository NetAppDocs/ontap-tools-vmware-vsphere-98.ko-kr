...
* ONTAP 툴을 구축해야 합니다.
* 을(를) 다운로드해야 합니다 `.msi` SRA 플러그인 또는 용 파일 `.tar.gz` SRM(Site Recovery Manager) 재해 복구 솔루션을 구성하려는 경우에만 SRM 어플라이언스에 대한 파일입니다.
+
...
| * SRM 어플라이언스 * 용 
 ...
 a| 
.. 다운로드한 을 두 번 클릭합니다 `.msi` SRA 플러그인용 설치 프로그램
.. 화면의 지침을 따릅니다.
